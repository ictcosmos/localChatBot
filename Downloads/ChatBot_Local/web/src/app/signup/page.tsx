...
export default function SignupPage() {
  ...
  const handleGuest = async () => {
    ...
    try {
      ...
      toast.error(err?.message || "Anonymous signup failed.");
    } finally {
      setLoadingAction(null);
    }
  };
          ...
          <section className="hidden bg-neutral-950 p-10 text-white lg:block">
            ...
            <div className="mt-20">
              ...
              <p className="mt-5 text-base leading-7 text-neutral-300">
                Use Google or Firebase Anonymous Auth. The app creates a
                Firestore profile automatically and connects your chats,
                uploaded documents, reasoning trace, and token logs.
              </p>
            </div>
            ...
            <div className="mt-12 rounded-3xl border border-white/10 bg-white/5 p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold">No Firebase Storage billing</p>
                  <p className="text-sm text-neutral-400">
                    Uploaded documents are stored locally on your device.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="p-6 sm:p-10">
            ...
            <div className="mt-8 rounded-2xl border border-amber-100 bg-amber-50 p-4 text-sm text-amber-800">
              ...
              <p className="mt-1 leading-6">
                Guest login is great for demo/testing. For long-term use,
                Google sign-in is easier to recover across devices.
              </p>
            </div>
